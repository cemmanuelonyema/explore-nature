    ...
    <section className="about" id="about">
      <div className="about__container">
        ...
        <div className="about__container-right">
          <div className="image-comp image-comp--1">
            <img
              src="img/rolands-varsbergs-miKmVyq3qhE-unsplash.jpg"
              alt="Photo 1"
            />
          </div>
          <div className="image-comp image-comp--2">
            <img src="img/pexels-jaime-reimer-2749500.jpg" alt="Photo 2" />
          </div>
          <div className="image-comp image-comp--3">
            <img
